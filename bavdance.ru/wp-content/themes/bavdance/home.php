...
<div class="container-wd">
            <div class="video-main">
                <img src="<?php echo get_image("slideshow-2.jpg");?>" class="img-responsive"/>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-5">
                        <div style="overflow: hidden; height: 340px;">
                            <img src="images/_sLSg5CpLeg.jpg" class="img-responsive" alt="">
                        </div>
       ...
       <div class="modal fade about" id="to-order" tabindex="-1" role="dialog" aria-hidden="true">
        ...
        <section class="bg our-prod" id="our-products-section">
            <div class="container-wd">
                ...
                <div class="section-content">
                    <img src="<?php echo get_image('sheme-work.png');?>" height="454" width="988" alt="Схема работы" class="center-block" />
                </div>
            </div>
        </section>
            ...
            <div class="container-wd">
                ...
                <div class="section-content">
                        ...
                        <div class="col-xs-4">
                            <div class="block">   
                                <div class="block-img">
                                    <img src="<?php echo get_image('slideshow-2.jpg');?>" height="1067" width="1600" alt="" class="img-responsive">
                                    <a class="circle">
            ...
            <div class="container-wd">
                ...
                <div class="media">
                    <div class="pull-left img">
                        <img src="<?php echo get_image('shutterstock_44142997.jpg');?>" alt="" class="img-responsive"/>
                    </div>
                    <div class="media-body">
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                              <a data-toggle="collapse" href="#collapseOne">
                                <div class="img">
                                    <img src="<?php echo get_image('vinyl-y-min.png');?>" class="center-block m-t-10" height="40" width="40" alt=""/>
                                </div>
