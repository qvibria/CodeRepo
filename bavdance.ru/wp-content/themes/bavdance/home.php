...
<div class="container">
    <img src="https://api.fnkr.net/testimg/1170x500/00CED1/FFF/?text=img+placeholder" class="img-responsive"/>
</div>
            ...
            <div class="row section-content">
                <div class="col-sm-3">
                    <div class="block-price">
                        <div class="block-price-header">
                            Эксперсс постановка
                            <p class="text-no">3000 р.</p>
                            <p class="text-extra-p">2500 р.</p>
                        </div>
                        <div class="block-price-content">
                            <ul class="pseudo-table">
                                <li>Консультации</li>
                                <li>Видеосъемка занятия</li>
                                <li>Урок 2 часа</li>
                                <li>Зал в любом районе СПб</li>
                            </ul>
                        </div>
                        <div class="block-price-footer">
                            <a class="btn btn-pink-border">Заказать</a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="block-price">
                        ...
                        <div class="block-price-content">
                            <ul class="pseudo-table">
                                <li>4 занятия</li>
                                <li>Консультации</li>
                                <li>Видеосъемка каждой репетиции</li>
                                <li>1 урок с 2-мя хореографами</li>
                                <li>Редактирование музыки</li>
                                <li>Зал в любом районе СПб</li>
                            </ul>
                        </div>
                        <div class="block-price-footer">
                ...
                <div class="col-sm-3">
                    <div class="block-price">
                        <div class="block-price-header">
                            Классик 6
                            <p class="text-no">8100 р.</p>
                            <p class="text-extra-p">7200 р.</p>
                        </div>
                        <div class="block-price-content">
                            <ul class="pseudo-table">
                                <li>6 занятий</li>
                                ...
                                <li>Видеосъемка каждой репетиции</li>
                                <li>1 урок с 2-мя хореографами</li>
                                <li>20 минут репетиции с выездом хореографа в день свадьбы( по необходимости)
                                </li>
                                <li>Редактирование музыки</li>
                                <li>Зал в любом районе СПб</li>
                            </ul>
                ...
                <div class="col-sm-3">
                    <div class="block-price">
                        <div class="block-price-header">
                            Люкс
                            <p class="text-no">22000 р.</p>
                            <p class="text-extra-p">17000 р.</p>
                        </div>
                        <div class="block-price-content">
                            <ul class="pseudo-table">
                                <li>Постановка любого танца «под ключ»</li>
                                <li>Консультации 24 часа</li>
                                <li>Видеосъемка каждой репетиции</li>
                                <li>2 урока с 2-мя хореографами</li>
                                <li>20 минут репетиции с выездом хореографа в день свадьбы</li>
                                <li class="text-extra">Свадебный координатор в день свадьбы!
                                </li>
                                <li>Скидка на дополнительные услуги студии 10 %</li>
                                <li>Редактирование музыки </li>
                                <li>Зал в любом районе СПб</li>
                            </ul>
                        </div>
            ...
            <!--          <div class="row">
                         <div class="col-md-4">
                             <div class="block-scheme">
                                 ...
                                 <div class="circle">
                                     <img src="images/sheme/list85.png" height="64" width="64" alt="">
                                 </div>
                         ...
                         <div class="col-md-4">
                             <div class="block-scheme">
                                 ...
                                 <div class="circle">
                                     <img src="images/sheme/party5.png" height="64" width="64" alt="">
                                 </div>
                         ...
                         <div class="col-md-4">
                             <div class="block-scheme">
                                 <div class="circle">
                                     <img src="images/sheme/shoe21.png" height="64" width="64" alt="">
                                 </div>
        ...
        <div class="section-content">
            <div class="row">
                <div class="col-sm-4">
                    <div class="block">   
                        <div class="block-img">
                            <img src="images/slideshow-2.jpg" height="1067" width="1600" alt="" class="img-responsive">
                            <a class="circle">
            ...
            <div id="carousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="item active">
                        <div class="media">
                            <div class="media-img">
                                <img src="images/slideshow-2.jpg" class="img-responsive">
                            </div>
                            <div class="media-body">
...
<section id="coordinator">
    <div class="container">
        ...
        <div class="section-content">
            <div class="media">
                <div class="pull-left" style="width: 300px; margin-right: 30px;">
                    <img src="images/shutterstock_44142997.jpg" alt="" class="img-responsive"/>
                </div>
                <div class="media-body">
                    ...
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" href="#collapseOne">
                                <div class="img">
                                    <img src="images/vinyl-y-min.png" class="center-block m-t-10" height="40" width="40" alt=""/>
                                </div>
